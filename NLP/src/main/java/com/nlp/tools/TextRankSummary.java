...
public class TextRankSummary
{
    ...
    public TextRankSummary(List<List<String>> docs,String query)
    {
        this.docs = docs;
        this.query = query;
        bm25 = new BM25(docs);
    ...
    private void solve()
    {
        int cnt = 0;
        /*
         * 初始权重v[0]=1,v[1,.....n]=0,说明query的权重最大，其他的小*/
...
//            System.out.println(Arrays.toString(scores));
     ...
     * @return 关键句列表
     */
    public static List<String> getTopSentenceList(String document, String querystring,int size)
    {
        List<String> sentenceList = spiltSentence(document);
        List<List<String>> docs = new ArrayList<List<String>>();
        sentenceList.add(querystring);     
        ...
        TextRankSummary textRankSummary = new TextRankSummary(docs,querystring);
